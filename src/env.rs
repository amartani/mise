...
pub static CODEBERG_TOKEN: Lazy<Option<String>> =
    Lazy::new(|| get_token(&["MISE_CODEBERG_TOKEN", "CODEBERG_TOKEN"]));
pub static MISE_FORGEJO_TOKEN: Lazy<Option<String>> =
    Lazy::new(|| get_token(&["MISE_FORGEJO_TOKEN"]));
